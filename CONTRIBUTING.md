...
* [GitHub Issues](https://github.com/InternationalColorConsortium/ics/issues)  
...
* [GitHub Discussions](https://github.com/InternationalColorConsortium/ics/discussions)  
...
follow the open source software best practice policies. The [International Color Consortium IP policy](https://www.color.org/ip-policy/) governs ICC specification development and contributions to ICC open source software. Software contributions are also covered by the Contributor License Agreement (CLA).
...
your account you should then **fork** the ICC software project repository
